...
describe('battle animation director', () => {
  ...
  describe('faint and push forward, checklist 3 and 4', () => {
    ...
    it('holds a lone corpse in its slot for a beat before it launches', () => {
      ...
      for (const launch of alone) {
        ...
        // Checklist 3's "dead in place first" is
    ...
    /**
     * How long a body lies in its slot depends on what killed
    ...
    /**
     * Off the 1:1 death strip: a body that was not hit at the midline is not
     * thrown anywhere.
     *
     ...
     * does exactly the same at t=30.82. Launching every corpse is wrong.
     */
  ...
  describe('projectiles, checklist 5, 6 and 15', () => {
    ...
    it('keeps the flight the same length whatever the distance', () => {
      ...
      // Measured: f02's rock is first visible at t=29.509 and the
    ...
    /**
     * Checklist 5. The engine calls a snipe and an attack buff the
    ...
    /**
     * A reward of attack and health at once is one object in
  ...
  describe('banner, checklist 11', () => {
     ...
     * damage.", one rock, on the amount. Drawing two wrapped the second onto
     * a line of its own under the card.
     */
  ...
  describe('trumpets, mana and xp, checklist 14 and 19', () => {
    ...
    it('lays a two part buff out side by side rather than stacked', () => {
      ...
      // The two throws are folded into one object, so both pills land
  ...
  describe('no entrance, and the end screen, checklist 18', () => {
    /**
     * The animation opens on the battle. There is no entrance segment, so
  ...
  describe('board state, anchoring and FAST cadence', () => {
