...
/**
 * The client's own build is unpacked, so the pieces that used to be
...
const FX = {
   ...
   * (f10 t=34.19 to 34.53), read off the buff close-up.
   */
 ...
 */
/*
 * Re-read on the reference: a pet's feet sit about 6px of a 960 wide
 ...
 * height, an arc a little under 45 degrees. An earlier 22 against 56 threw the
 * corpse almost straight up, a visibly steeper arc than the client's.
 */
 ...
 *
 * 24 links over eight cluster points still left gaps. On
  ...
  implements AfterViewInit, OnChanges, OnDestroy
{
   ...
   * is on f06 at t=30.82). An earlier pass had the trail and not this.
   */
   ...
   *
   * Measured on f02's "8" frame by frame: it spawns about 59 by 92 px
   ...
   * for its whole life, which was the loudest difference on every comparison
   * sheet.
   */
   ...
   */
  /*
   * Counted on f02 t=32.13, the spray is four saturated gold stars
