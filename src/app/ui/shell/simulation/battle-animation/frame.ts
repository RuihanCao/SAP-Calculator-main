...
import { AnimationBeats, OUTRO_BEATS, getBeats } from './timing';
 ...
 *
 * An earlier reading had only the contact frame and took it for half the arc.
 * The apex frame says the contact is closer to two fifths of it, and that the
 * arc is a third taller than a move's.
 */
