...
## Now
- [ ] Fix record_calc.py DOM fragility (stage reparent kills the .anim-clock read), then re-record all 16 fixtures + FAST set on the current skin to close the evidence gap (added 2026-08-01; context: RESULTS.md qualifier)
